...
*/
     ...
     */
	 ...
	 //-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
	 //-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
	 // BD ------Rename de la procedure to_HTML car elle provoque l'affichage de #cmd# dans le widget  --> A VIRER ULTERIEUREMENT------------------------------
	public function toHtml_a_virer($_version = 'dashboard') {
